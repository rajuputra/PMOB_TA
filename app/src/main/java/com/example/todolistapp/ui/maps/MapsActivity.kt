package com.example.todolistapp.ui.maps
...
import com.example.todolistapp.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        //coordinate jogja
        val jogjaPride = LatLng(-7.797068, 110.370529)
        mMap.addMarker(
            MarkerOptions()
                .position(jogjaPride)
                .title("Jogja Pride")
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(jogjaPride, 15f))
...
//    }
    ...
    private fun addManyMarker() {
        val tourismPlace = listOf(
            TourismPlace("Pekanbaru", 0.5072677932237106, 101.45284525845933),
            TourismPlace("Cilacap", -7.697963963275516, 109.02343879540591),
            TourismPlace("Jambi", -1.609577814108194, 103.61536406128207)
